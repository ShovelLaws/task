...
public class BackController {
    ...
    public String uploadImage(MultipartFile img,ModelMap modelMap)throws Exception{
        ...
        public String login(@RequestBody Account accountx, ModelMap modelMap, HttpSession session){
        ...
        public String loadTheme(@RequestBody Title title, ModelMap modelMap){
