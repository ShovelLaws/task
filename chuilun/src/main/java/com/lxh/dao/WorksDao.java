...
public interface WorksDao {
    ...
    List<Works> doGetList(@Param("title_id") int title_id, @Param("start") int start, @Param("size") int size);

    List<Works> doSearch(@Param("words") String words, @Param("start") int start, @Param("size") int size);
